...
//     omp_set_threads_num(4);
    #pragma omp parallel for schedule(static, 2) private(i, j, m, n, rowMax, rowMin, colMax, colMin, sum, inPtr, inPtr2, outPtr)	
	...
	inPtr2=start_in+(i*dataSizeX);
        inPtr=inPtr2;
        outPtr=start_out+(i*dataSizeX);
...
*/
    ...
    long position=0;
    double ftime, start, tstart=0, tend=0, tread=0, tcopy=0, tconv=0, tstore=0, treadk=0;
    ...
    ImagenData source=NULL, output=NULL, output1=NULL , output2=NULL, Rtest=NULL, Gtest=NULL, Btest=NULL;
...
//master
	...
	int *BufferRtest=NULL, *BufferGtest=NULL, *BufferBtest=NULL;
